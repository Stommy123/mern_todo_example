...
const SignUpFormContent = ({ email, password, firstName, lastName, dob, onChange }) => (
  <>
    ...
    <input type='date' required placeholder='Date of Birth' value={dob} onChange={onChange('dob')} />
...
const TaskFormContent = ({ name, description, dueDate, onChange }) => (
  <>
    ...
    <input type='date' placeholder='Due Date' value={dueDate} onChange={onChange('dueDate')} />
  </>
);
